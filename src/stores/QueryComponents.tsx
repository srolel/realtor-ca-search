...
export class Query<T> {
  ...
  static fromJS<T extends { [index: string]: any }>(
    arr: T | T[],
    presets?: any
  ) {
    const q = new Query<T>();
        ...
        return (
          <div>
            <input
              ...
              value={queryInstance.min}
            />
            <input
              type="number"
              onChange={this.onChangeMax}
              value={queryInstance.max}
            />
          </div>
        );
      }
  ...
  getComponent() {
    ...
    class StringSearchableComponent extends React.Component<any, any> {
      ...
      render() {
        return (
          <div>
            <input value={queryInstance.value} onChange={this.onChange} />
          </div>
        );
      }
    }
      ...
      render() {
        ...
        return (
          <div>
            <select
              multiple
              value={selected ? toJS(selected) : []}
              onChange={this.onChange}
            >
              <option></option>
              {queryInstance.sortedOptions.map((o) => (
